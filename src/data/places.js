...
export const PLACES = [
  ...
  },
  {
    ...
    seoDescription:
      'Que faire à Constantine : pont Sidi M\'Cid, palais Ahmed Bey, musée de Cirta, mosquées et gastronomie locale. Séjour et excursion avec Algeria Travel.',
    seoDescription_en:
      'Things to do in Constantine: Sidi M\'Cid bridge, Ahmed Bey palace, Cirta Museum, mosques and local cuisine. Stays and tours with Algeria Travel.',
    seoDescription_ar:
      'ماذا تفعل في قسنطينة: جسر سيدي مسيد، قصر أحمد باي، متحف قيرطا، مساجد ومطبخ محلي. إقامات وجولات مع Algeria Travel.',
    bestTime: 'Mars – Juin / Sept – Nov',
    bestTime_en: 'March – June / Sept – Nov',
    bestTime_ar: 'مارس – يونيو / سبتمبر – نوفمبر',
    duration: '3 jours',
    ...
    includes: [
      { fr: 'Hébergement 2 nuits', en: '2 nights stay', ar: 'إقامة ليلتين' },
      { fr: 'Pont Sidi M\'Cid & ponts historiques', en: 'Sidi M\'Cid & historic bridges', ar: 'جسر سيدي مسيد والجسور التاريخية' },
      { fr: 'Palais Ahmed Bey & musée de Cirta', en: 'Ahmed Bey palace & Cirta Museum', ar: 'قصر أحمد باي ومتحف قيرطا' },
      { fr: 'Mosquée Emir Abdelkader', en: 'Emir Abdelkader Mosque', ar: 'مسجد الأمير عبد القادر' },
      { fr: 'Guide francophone', en: 'French-speaking guide', ar: 'مرشد ناطق بالفرنسية' },
    ],
    highlights: [
      { icon: 'Route', fr: 'Pont Sidi M\'Cid (175 m)', en: 'Sidi M\'Cid bridge (175 m)', ar: 'جسر سيدي مسيد' },
      { icon: 'Landmark', fr: 'Palais Ahmed Bey', en: 'Ahmed Bey palace', ar: 'قصر أحمد باي' },
      { icon: 'Building2', fr: 'Musée national de Cirta', en: 'Cirta National Museum', ar: 'متحف قيرطا الوطني' },
      { icon: 'UtensilsCrossed', fr: 'Chakhchoukha & mhajeb', en: 'Chakhchoukha & mhajeb', ar: 'شخشوخة ومحاجب' },
      { icon: 'Mountain', fr: 'Gorges du Rhummel', en: 'Rhummel gorges', ar: 'مضيق الرمال' },
    ],
  },
];
